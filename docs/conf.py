...
source_dir = os.path.join(os.path.dirname(__file__), '..', 'biosimulators_boolnet')
sys.path.insert(0, os.path.join(os.path.dirname(__file__), '..'))

# -- Project information -----------------------------------------------------
source_base_url = 'https://github.com/biosimulators/BioSimulators_BoolNet/blob/dev/'
project = 'BioSimulators-BoolNet'
...
html_theme_options = {
    ...
    'github_repo': 'BioSimulators_BoolNet',
    'github_banner': True,
    'github_button': True,
    'description': 'BioSimulators-compliant interface to BoolNet',
    'fixed_sidebar': True,
